...
def bing_request(offset, keyBing):
    ...
    searchString = '%27site%3Ancsl.org%20%22legislation.aspx%22%27'
    top = 50
...
outfile = io.open('../../data/ncsl/scraped_table_urls.csv', 'w+', encoding='utf-8')
...
while True:
    ...
    for result in response['d']['results']:
        ...
        # Write row to file
        row = '{},{},{},{},{}\n'.format(id_,title,url_,description,uri)
        outfile.write(row)
