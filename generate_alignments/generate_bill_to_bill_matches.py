...
if __name__ == "__main__":
    ...
    #configure logging
    logging.basicConfig(filename="{0}/logs/state_legislation_alignment.log".format("/Users/flinder/projects/text_reuse/policy_diffusion"),
                level=logging.DEBUG)
    ...
    lidy = LID(query_results_limit=1000, elastic_host=ip_addy, 
