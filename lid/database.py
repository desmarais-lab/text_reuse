...
class ElasticConnection():
    ...
    def get_bill_by_id_new(self, _id, index='state_bills',  
            _source_include='bill_document_last'):

        match = self.es_connection.get_source(id=_id, index=index, 
                doc_type='_all', _source_include='bill_document_last')
        return match
