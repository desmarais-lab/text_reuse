...
%        \centering
%        \includegraphics[height=1.2in]{figures/ncsl_pr_nosplit.png}
%        \caption{Lorem ipsum}
%    \end{subfigure}%
%    ~ 
%    \begin{subfigure}[b]{0.5\textwidth}
%        \centering
%        \includegraphics[height=1.2in]{figures/ncsl_pr_cosim.png}
...
deviation of cross state alignment scores. $p$-values based on 5,000 QAP permuations.}
