...
\subfigure[Precision recall curve for boilerplate adjusted
scores]{\label{fig:prec_rec_adj}\includegraphics[width=0.4\textwidth]{figures/ncsl_prec_rec_adj.png}}
\subfigure[Precision recall curve for unweighted
scores]{\label{fig:prec_rec_old}\includegraphics[width=0.4\textwidth]{figures/ncsl_prec_rec_old.png}}
