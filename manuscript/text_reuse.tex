...
We will rely on three main data sources to assess the reliability of text reuse to
identify substantively equivalent bills. 

\subsection{Bill text}\\
...
\subsection{Ground truth - NCSL Tables}\\
