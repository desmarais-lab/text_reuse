...
class ElasticConnection():
    ...
    def retrieve_bills(self, bill_ids, return_fields):
        # TODO: elastic search bill retrieval code here. If possible on whole
        # list of ids
        pass
    
    
    def similar_doc_query(self,query,state_id = None,num_results = 100,
            return_fields = ["state"], index = STATE_BILL_INDEX):
        json_query = 
            {
                "query": {
                    "more_like_this": {
